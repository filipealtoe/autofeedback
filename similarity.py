...
if __name__ == '__main__':   
    ...
    similarity_results = similarity.debug_highest_sim_summary()
    rubrictext = similarity_results['rubrictext']
    returnedsimilaties = similarity_results['similarities']
    maxsimilarity = similarity_results['maxsimilarity']
    print (rubrictext)
