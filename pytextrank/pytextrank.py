...
def parse_graf (doc_id, graf_text, base_idx, spacy_nlp=None):
    ...
    #FILIPE: Changed per https://github.com/DerwenAI/pytextrank/issues/15
...
def build_graph (json_iter):
    ...
    for meta in json_iter:
        ...
        for pair in get_tiles(map(WordNode._make, meta["graf"])):
            ...
            try:
                #FILPE: Changed per https://github.com/DerwenAI/pytextrank/issues/18#issuecomment-390398883
